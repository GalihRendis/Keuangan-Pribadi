    ...
    <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
        <div class="modal-content bg-gradient-danger">
            <div class="modal-header">
              <h6 class="modal-title" id="modal-title-notification">Hapus Data Kebutuhan</h6>
            ...
            <div class="modal-body">
                <div class="py-3 text-center">
                    ...
                    <h4 class="heading mt-4">Apakah anda yakin untuk menghapus Kebutuhan ini?</h4>
                    <p>Menghapus data Kebutuhan akan menghapus semua yang berhubungan dengan Kebutuhan.</p>
                </div>
            </div>
...
<script>
  $(document).ready(function () {
    $("#tabel-form").on('click', '.hapus-data', function () {
        ...
        document.getElementById("btn-hapus").href= "/SI/kebutuhan/" + id[2] + "/delete";
    });
});
