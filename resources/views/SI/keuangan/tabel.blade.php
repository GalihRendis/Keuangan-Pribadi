...
<div class="card-header border-0">
  <div class="row">
    <div class="col-6">
      <h3 class="mb-0">Tabel Keuangan</h3>
  ...
  <table class="table align-items-center table-flush table-striped" id="tabel-form">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="table-user">
          Rp. {{ number_format($d->uang_masuk,0,',','.'); }}
        </td>
        <td>
...
<!-- Modal Tambah -->
@include('SI.keuangan.tambah')

<!-- Modal Ubah -->
@include('SI.keuangan.ubah')

<!-- Modal Hapus -->
@include('SI.keuangan.hapus')

<!-- Modal Search -->
@include('SI.keuangan.search')
